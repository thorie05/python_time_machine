...
class FittingEngine:
    ...
    Note:
        The only_positive flag is set to True in all wrapper methods, overriding
        the default value (False) used in the underlying fitting functions.
    ...
    def bootstrap_fit(self, n, x_data, y_data, model_function,
        ...
        known_params_err_std=None, only_positive=True, seed=None):
